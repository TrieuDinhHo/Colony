...
DATA_GC_URI_TRAIN = {
    ...
    224: '/content/drive/MyDrive/Data/tfrecord/',
}
...
class DataWriter():
    def __init__(self, src_path, dest_path="/", batch_size=25, height=224, width=224):
...
class DataReader():
    ...
    def __init__(self, src_path="", height=224, width=224, depth=3):
        self.src_path = src_path
    ...
    def parse_tfr_element(self, element):
        ...
        label = tf.reshape(label, shape=[self.height, self.width,1])
    ...
    def get_dataset_training(self, image_size=224, validation=True):
        ...
        if validation:
            ...
            for i in range(36): # 36 is 30% amount of entire data
                valdir = src_path + "record_{}.tfrecords".format(i)
